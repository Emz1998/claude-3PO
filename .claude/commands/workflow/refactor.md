...
1. Delegate initial refactoring to @agent-fullstack-developer.
2. Do a final review of the code for correctness and identify any issues, possible bugs and improvements.
3. If issues are found, do the final refactoring yourself instead of delegating to the fullstack-developer agent.
