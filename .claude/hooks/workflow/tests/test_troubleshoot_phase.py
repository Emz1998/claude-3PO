...
class TestCanBypassFrom:
    ...
    def test_can_bypass_from_coding_phases(self):
        ...
        for phase in coding_phases:
            assert can_bypass_from("troubleshoot", phase) is True, f"Should bypass from {phase}"
    ...
    def test_cannot_bypass_from_pre_coding_phases(self):
        ...
        for phase in pre_coding_phases:
            assert can_bypass_from("troubleshoot", phase) is False, f"Should not bypass from {phase}"
...
class TestPhaseTrackerTroubleshoot:
    ...
    def test_phase_tracker_activates_troubleshoot(self, tmp_path):
        ...
        with patch("trackers.phase_tracker.get_manager", return_value=manager), \
             patch("trackers.phase_tracker.get_tracker") as mock_tracker:
