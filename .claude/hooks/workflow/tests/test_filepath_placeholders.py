    ...
    def test_both_placeholders_resolved(self):
        ...
        with patch.dict(
            ...
            result = resolve_filepath_placeholders(
                "{project}/plans/foo_{session}.md"
            )
            assert (
                result == "project/v0.1.0/EPIC-001/FEAT-001/plans/foo_1ab7b734.md"
            )
...
class TestRegexConversion:
    ...
    def test_wildcards_still_work_star(self):
        ...
        assert re.match(
            regex, "project/v0.1.0/EPIC-001/FEAT-001/plans/foo_abc123.md"
        )
        assert re.match(
...
class TestEndToEnd:
    ...
    def test_scoped_pattern_rejects_other_features(self):
        ...
        with patch.dict(
            ...
            regex = deliverable.regex_pattern
            current_path = (
                "project/v0.1.0/EPIC-001/FEAT-001/plans/final-plan_abc123.md"
            )
            other_feature = (
                "project/v0.1.0/EPIC-001/FEAT-002/plans/final-plan_abc123.md"
            )
