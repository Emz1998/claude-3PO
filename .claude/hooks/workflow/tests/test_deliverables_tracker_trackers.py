...
def tracker():
    ...
    with patch("trackers.deliverables_tracker.get_manager") as mock_manager, \
         patch("trackers.deliverables_tracker.get_deliverables_tracker") as mock_deliverables:
...
class TestTrack:
    ...
    def test_track_marks_deliverable_complete(self):
        ...
        with patch("trackers.deliverables_tracker.get_manager") as mock_manager, \
            ...
            mock_del_tracker.mark_complete.assert_called_once_with("write", "/path/to/file.ts")
