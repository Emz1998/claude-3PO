...
class TestRefreshCurrentTasks:
    ...
    def test_refresh_current_tasks(self, mock_state):
        ...
        with patch("release_plan.resolvers._load_state") as mock_load, \
             patch("release_plan.resolvers._save_state") as mock_save, \
             patch("release_plan.resolvers.load_release_plan") as mock_rp, \
             patch("release_plan.resolvers.get_all_tasks_ids_in_user_story") as mock_get, \
             patch("release_plan.resolvers.is_task_completed") as mock_completed, \
             patch("release_plan.resolvers.is_task_allowed") as mock_allowed:
            mock_load.return_value = mock_state
...
class TestRecordCompleted:
    ...
    def test_record_completed_task(self, mock_state):
        ...
        with patch("release_plan.resolvers._load_state") as mock_load, \
             patch("release_plan.resolvers.is_task_completed") as mock_check, \
             patch("release_plan.resolvers.set_completed_tasks") as mock_set, \
             patch("release_plan.resolvers.refresh_current_tasks"):
            mock_load.return_value = mock_state
    ...
    def test_record_completed_user_story(self, mock_state):
        ...
        with patch("release_plan.resolvers.is_user_story_completed") as mock_check, \
             patch("release_plan.resolvers.set_completed_user_stories") as mock_set:
            mock_check.return_value = True
    ...
    def test_record_completed_feature(self, mock_state):
        ...
        with patch("release_plan.resolvers.is_feature_completed") as mock_check, \
             patch("release_plan.resolvers.set_completed_features") as mock_set:
            mock_check.return_value = True
    ...
    def test_record_completed_epic(self, mock_state):
        ...
        with patch("release_plan.resolvers.is_epic_completed") as mock_check, \
             patch("release_plan.resolvers.set_completed_epics") as mock_set:
            mock_check.return_value = True
    ...
    def test_record_met_ac(self, mock_state):
        """Records met AC."""
        with patch("release_plan.resolvers.is_ac_met") as mock_check, \
             patch("release_plan.resolvers.set_met_acs") as mock_set:
            mock_check.return_value = True
    ...
    def test_record_met_sc(self, mock_state):
        """Records met SC."""
        with patch("release_plan.resolvers.is_sc_met") as mock_check, \
             patch("release_plan.resolvers.set_met_scs") as mock_set:
            mock_check.return_value = True
...
class TestBatchResolvers:
    ...
    def test_resolve_tasks(self, mock_state):
        ...
        with patch("release_plan.resolvers.get_current_tasks_ids") as mock_get, \
             patch("release_plan.resolvers.record_completed_task") as mock_record:
    ...
    def test_resolve_completed_acs(self, mock_state):
        ...
        with patch("release_plan.resolvers.get_current_acs_ids") as mock_get, \
             patch("release_plan.resolvers.record_met_ac") as mock_record:
    ...
    def test_resolve_completed_scs(self, mock_state):
        ...
        with patch("release_plan.resolvers.get_current_scs_ids") as mock_get, \
             patch("release_plan.resolvers.record_met_sc") as mock_record:
...
class TestComplexResolvers:
    ...
    def test_resolve_user_story_moves_to_next(self, mock_state):
        ...
        with patch("release_plan.resolvers._load_state") as mock_load, \
             patch("release_plan.resolvers.resolve_tasks"), \
             patch("release_plan.resolvers.resolve_completed_acs"), \
             patch("release_plan.resolvers.resolve_completed_scs"), \
             patch("release_plan.resolvers.is_user_story_completed") as mock_check, \
             patch("release_plan.resolvers.record_completed_user_story"), \
             patch("release_plan.resolvers.load_release_plan") as mock_rp, \
             patch("release_plan.resolvers.get_next_user_story_id_in_feature") as mock_next, \
             patch("release_plan.resolvers.set_current_user_story"), \
             patch("release_plan.resolvers.initialize_tasks") as mock_init_tasks, \
             patch("release_plan.resolvers.initialize_acs") as mock_init_acs, \
             patch("release_plan.resolvers.set_current_tasks"), \
             patch("release_plan.resolvers.set_current_acs"):
            mock_load.return_value = mock_state
            mock_check.return_value = True
            mock_rp.return_value = {}
