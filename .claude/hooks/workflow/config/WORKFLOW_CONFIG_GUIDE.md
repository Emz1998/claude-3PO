...
8. [Pattern Syntax](#pattern-syntax)
...
1. Use `folder:` to specify the parent directory
2. Use `pattern:` for the filename pattern
3. Remember `*` doesn't match `/`, use `**` for paths
