...
class TaskCreatedGuard:
    ...
    def _match_substring(subject: str, candidates: list[str]) -> str | None:
        ...
        Args:
            ...
            candidates (list[str]): Allowed task titles to match against.

        Returns:
            str | None: The matched candidate, or ``None`` if none matched.

        Example:
            >>> TaskCreatedGuard._match_substring("Add login", ["Add login flow"])
            'Add login flow'
        """
    ...
    def _check_task_fields(self, subject: str, description: str) -> None:
        ...
        Example:
            ...
            >>> guard._check_task_fields("Add login", "")  # doctest: +SKIP
        """
    ...
    def _validate_build_task(self, subject: str) -> str:
        ...
        Example:
            >>> message = guard._validate_build_task("Add login")  # doctest: +SKIP
        """
    ...
    def _validate_implement_task(self, task_id: str, subject: str) -> str:
        ...
        On success, calls :meth:`_set_implement_match` to populate the
    ...
    def _set_implement_match(
        ...
        Args:
            ...
            matched_title (str): Title returned by :meth:`_match_substring`.
            task_id (str): Claude-assigned task ID for the new child.
            subject (str): Subject of the new child task.

        Example:
            >>> guard._set_implement_match(project_tasks, "Add login flow", "t-1", "Add login")  # doctest: +SKIP
        """
