...
class CommandGuard:
    ...
    def check_pr_create_json(self) -> None:
        """
        ...
        Example:
            ...
            >>> guard.check_pr_create_json()  # doctest: +SKIP
        """
    ...
    def check_ci_check_json(self) -> None:
        """
        ...
        Example:
            ...
            >>> guard.check_ci_check_json()  # doctest: +SKIP
        """
    ...
    def validate(self) -> Decision:
        ...
        try:
            ...
            # Extra JSON enforcement for gh commands we later parse structurally.
            if self.phase == "pr-create":
                self.check_pr_create_json()
            if self.phase == "ci-check":
                self.check_ci_check_json()
