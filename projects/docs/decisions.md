...
**Rationale:** JavaScript full-stack consistency, large ecosystem, team familiarity.  
**Trade-offs:** Less performant than Go for CPU-intensive tasks, but adequate for I/O-bound workloads.
...
**Rationale:** Faster to build for MVP, easier to debug, no distributed systems overhead.  
**Trade-offs:** Harder to scale individual services later, but migration path exists.
...
**Decision:** GitHub Actions + AWS CodeDeploy  
...
**Decision:** Slack, GitHub, Linear  
**Rationale:** Where developers already work — meet users where they are.  
**Trade-offs:** Maintenance burden of 3 integrations for MVP.
