...
from workflow.sprint.sprint_types import SprintState  # type: ignore
from workflow.sprint.sprint_config import SprintConfig  # type: ignore
from workflow.sprint.sprint_context import SprintContext  # type: ignore
from workflow.sprint.story_manager import StoryManager  # type: ignore
from workflow.sprint.task_manager import TaskManager  # type: ignore
...
if __name__ == "__main__":
    sprint = Sprint.create(Path("project/test.json"))
    print(sprint.state)
